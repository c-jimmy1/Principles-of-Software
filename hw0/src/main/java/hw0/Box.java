...
public class Box implements Iterable<Ball> {
    ...
    public Iterator<Ball> getBallsFromSmallest() {
        ...
        while (iterator.hasNext()) {
            ballsList.add(iterator.next());
        }

        Comparator<Ball> volumeComparator = Comparator.comparingDouble(Ball::getVolume);
        Collections.sort(ballsList, volumeComparator);

        return ballsList.iterator();
    }
