...
public final class RatNumTest {
  ...
  public void testDoubleValueNaN() {
    assertTrue(Double.valueOf(one_I_zero.doubleValue()).isNaN());
  }
  ...
  public void testFloatValueNaN() {
    assertTrue(Float.valueOf(one_I_zero.floatValue()).isNaN());
  }
  ...
  public void testIntValueUnsupported() {
    if (false) {
      ...
      assertEquals(1, new RatNum(Integer.MIN_VALUE + 1, Integer.MIN_VALUE).intValue(),
    		  "(MIN_VALUE+1)/MIN_VALUE should round to 1");
      assertEquals(0, new RatNum(1, Integer.MIN_VALUE).intValue(),
    		  "1/MIN_VALUE should round to 0");
    }
  }

  @Test
  public void testIntValueWithOutRound() {
    assertEquals(0, zero.intValue(), "0 should round to 0");
    assertEquals(1, one.intValue(), "1 should round to 1");
    assertEquals(-1, negOne.intValue(), "-1 should round to -1");
  }

  @Test
  public void testIntValueWithRoundtoPosOne() {
    assertEquals(1, one_I_two.intValue(), "1/2 should round to 1");
    assertEquals(1, two_I_three.intValue(), "2/3 should round to 1");
    assertEquals(1, three_I_four.intValue(), "3/4 should round to 1");
  }

  @Test
  public void testIntValueWithRoundtoNegOne() {
    assertEquals(-1, one_I_two.negate().intValue(),"-1/2 should round to -1");
    assertEquals(-1, two_I_three.negate().intValue(),"-2/3 should round to -1");
    assertEquals(-1, three_I_four.negate().intValue(), "-3/4 should round to -1");
  }

  @Test
  public void testIntValueWithRoundMaxValue() {
    assertEquals(Integer.MAX_VALUE, new RatNum(Integer.MAX_VALUE).intValue(),
    		"MAX_VALUE should round to MAX_VALUE");      
    assertEquals((Integer.MAX_VALUE / 2) + 1, new RatNum(Integer.MAX_VALUE, 2).intValue(),
    		"MAX_VALUE/2 should round to (MAX_VALUE/2)+1");           
  }

  @Test  //Ensure 1 / Max Value == 0
  public void testIntValueWithRoundOneOverMaxValue() {
    assertEquals(0, new RatNum(1, Integer.MAX_VALUE).intValue(),
    		"1/MAX_VALUE should round to 0");
  }

  @Test  //Ensure Max Value / Max Value == 1
  public void testIntValueMaxValueDivByMaxValue() {
    assertEquals(1, new RatNum(Integer.MAX_VALUE, Integer.MAX_VALUE).intValue(),
    		"MAX_VALUE/MAX_VALUE should round to 1");
    assertEquals(1, new RatNum(Integer.MAX_VALUE - 1, Integer.MAX_VALUE).intValue(),
    		"(MAX_VALUE-1)/MAX_VALUE should round to 1");
  }

  @Test  
  public void testIntValueWithRoundMinValue() {
    assertEquals(Integer.MIN_VALUE, new RatNum(Integer.MIN_VALUE).intValue(),
    		"MIN_VALUE should round to MIN_VALUE");
    assertEquals((Integer.MIN_VALUE / 2), new RatNum(Integer.MIN_VALUE, 2).intValue(),
    		"MIN_VALUE/2 should round to (MIN_VALUE/2)");      
  }

  @Test //Ensure Min Value / Min Value == 1
  public void testIntValueMinValueDivByMinValue() {
    assertEquals(1, new RatNum(Integer.MIN_VALUE, Integer.MIN_VALUE).intValue(),
