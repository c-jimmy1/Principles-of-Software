...
public final class RatPolyTest {
  ...
  private void eqP(String s, int anticipDegree, RatNum[] anticipCoeffs) {
    ...
    for (int i = 0; i <= anticipDegree; i++) {
      assertTrue(p.getCoeff(anticipDegree - i).equals(anticipCoeffs[i]),
  ...
  public void testDegreeZero() {
    assertEquals(0, poly(1, 0).degree(), "x^0 degree 0");
    assertEquals(0, poly(0, 100).degree(), "0*x^100 degree 0");
    assertEquals(0, poly(0, 0).degree(), "0*x^0 degree 0");
  }

  @Test
  public void testDegreeNonZero() {
    assertEquals(1, poly(1, 1).degree(), "x^1 degree 1");
    assertEquals(100, poly(1, 100).degree(), "x^100 degree 100");
  }

  @Test // test degree for multi termed polynomial
  public void testDegreeNonZeroMultiTerm() {
    assertEquals(5, poly1.degree(), poly1.toString() + " has Correct Degree");
    assertEquals(4, poly2.degree(), poly2.toString() + " has Correct Degree");
  }
  ...
  public void testEvalZero() {
    ...
    assertEquals(0.0, zero.eval(0.0), JUNIT_DOUBLE_DELTA, " 0 at 0 ");
    assertEquals(0.0, zero.eval(1.0), JUNIT_DOUBLE_DELTA, " 0 at 1 ");
    assertEquals(0.0, zero.eval(2.0), JUNIT_DOUBLE_DELTA, " 0 at 2 ");
  }
  ...
  public void testEvalOne() {
    ...
    assertEquals(1.0, one.eval(0.0), JUNIT_DOUBLE_DELTA, " 1 at 0 ");
    assertEquals(1.0, one.eval(1.0), JUNIT_DOUBLE_DELTA, " 1 at 1 ");
    assertEquals(1.0, one.eval(2.0), JUNIT_DOUBLE_DELTA, " 1 at 1 ");
  }
  ...
  public void testEvalX() {
    ...
    assertEquals(0.0, _X.eval(0.0), JUNIT_DOUBLE_DELTA, " x at 0 ");
    assertEquals(1.0, _X.eval(1.0), JUNIT_DOUBLE_DELTA, " x at 1 ");
    assertEquals(2.0, _X.eval(2.0), JUNIT_DOUBLE_DELTA, " x at 2 ");
  }
  ...
  public void testEval2X() {
    ...
    assertEquals(0.0, _2X.eval(0.0), JUNIT_DOUBLE_DELTA, " 2*x at 0 ");
    assertEquals(2.0, _2X.eval(1.0), JUNIT_DOUBLE_DELTA, " 2*x at 1 ");
    assertEquals(4.0, _2X.eval(2.0), JUNIT_DOUBLE_DELTA, " 2*x at 2 ");
  }

  @Test
  public void testEvalXsq() {
    RatPoly _XSq = new RatPoly(1, 2);
    assertEquals(0.0, _XSq.eval(0.0), JUNIT_DOUBLE_DELTA, " x^2 at 0 ");
    assertEquals(1.0, _XSq.eval(1.0), JUNIT_DOUBLE_DELTA, " x^2 at 1 ");
    assertEquals(4.0, _XSq.eval(2.0), JUNIT_DOUBLE_DELTA, " x^2 at 2 ");
  }
  ...
  public void testEvalXSq_minus_2X() {
    ...
    assertEquals(0.0, _XSq_minus_2X.eval(0.0), JUNIT_DOUBLE_DELTA, " x^2-2*x at 0 ");
    assertEquals(-1.0, _XSq_minus_2X.eval(1.0), JUNIT_DOUBLE_DELTA, " x^2-2*x at 1 ");
    assertEquals(0.0, _XSq_minus_2X.eval(2.0), JUNIT_DOUBLE_DELTA, " x^2-2*x at 2 ");
    assertEquals(3.0, _XSq_minus_2X.eval(3.0), JUNIT_DOUBLE_DELTA, " x^2-2*x at 3 ");
  }
  ...
  public void testIntegrateZero() {
    assertEquals(0.0, RatPoly.ZERO.integrate(0, 10), JUNIT_DOUBLE_DELTA, "Integrate f(x) = 0 from 0 to 10");
  }
  
  @Test
  public void testIntegrateOne() {
    assertEquals(10.0, RatPoly.valueOf("1").integrate(0, 10), JUNIT_DOUBLE_DELTA, "Integrate f(x) = 1 from 0 to 10");
  }
  
  @Test
  public void testIntegrateNaN() {
    assertEquals(RatPoly.valueOf("NaN").integrate(0, 1), Double.NaN, JUNIT_DOUBLE_DELTA, "NaN");
  }
}
